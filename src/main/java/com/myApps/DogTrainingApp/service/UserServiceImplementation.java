...
public class UserServiceImplementation implements UserService{
    ...
    public void saveUser(User theUser) {
        ...
        if(name == null || !name.matches("[A-Za-z0-9]+") || name.length()>20){
            throw new IllegalArgumentException("Username can only have 1-20 english letters and numbers as characters.");
        }
        String password = theUser.getPassword();
        if(password == null || !password.matches("[A-Za-z0-9!?*_.]+") || password.length()>20){
            throw new IllegalArgumentException("Password can only have 1-20 english letters, numbers and !?*_. as characters.");
        }
